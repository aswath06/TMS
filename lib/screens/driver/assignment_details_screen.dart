                            ...
                            onPressed: isSubmitting
                                ...
                                : () async {
                                    ...
                                    if (allowanceNeeded == true && selectedAllowanceTypes.isEmpty) {
                                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Please select at least one allowance type"), backgroundColor: Colors.orange));
                                      return;
                                    }
                                    ...
                                    if (allowanceNeeded == true && selectedAllowanceTypes.isNotEmpty) {
                                      ...
                                      if (grandTotal > 300 && proofImage == null) {
                                        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Image proof is mandatory for amounts > 300"), backgroundColor: Colors.red));
                                        return;
                                      }
                                    }
                                    ...
                                    final int? passCount = (_userRole == 'driver') ? null : (int.tryParse(passengerController.text) ?? 0);
